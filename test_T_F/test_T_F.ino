...
void loop() {
  ...
  if(WiFi.status()== WL_CONNECTED) {
    ...
    http.begin(client,"http://127.0.0.1/baby_monitor/getdata.php");  //--> Specify request destination
    ...
    // Example : http.begin("http://localhost/baby_monitor/baby_monitor.php");
    http.begin(client,"http://127.0.0.1/baby_monitor/baby_monitor.php");  //--> Specify request destination
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");  //--> Specify content-type header
